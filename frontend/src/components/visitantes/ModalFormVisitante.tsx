        ...
        {usuario?.e_admin && (
          <div className="space-y-1.5 text-left w-full">
            ...
            <select
              ...
              className="block w-full max-w-full h-11 min-h-[44px] max-h-11 rounded-xl border border-slate-300 bg-white text-slate-900 text-sm px-3.5 py-2 focus:outline-none focus:ring-2 focus:ring-[#1E3370] transition-smooth box-border"
            >
              {usuarios.map((u) => (
